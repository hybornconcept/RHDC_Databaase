...
1. Open `sql/schema.sql` from this repository
...
2. Open `sql/seed_data.sql`, copy all contents
...
2. Open `sql/queries_views.sql`, copy all contents
3. Paste and click **Run**
...
-- 7. Full demo
-- Run sql/demo_queries.sql section by section
```
